...
extern nvJitLinkResult __nvJitLinkCreate_13_3(
...
static inline nvJitLinkResult nvJitLinkCreate(
  ...
  const char **options)
{
  return __nvJitLinkCreate_13_3 (handle, numOptions, options);
}
#else
extern nvJitLinkResult nvJitLinkCreate(
  nvJitLinkHandle *handle,
  uint32_t numOptions,
  const char **options);
#endif
 
extern nvJitLinkResult __nvJitLinkDestroy_13_3 (nvJitLinkHandle *handle);
/**
 * \ingroup linking
...
{
  return __nvJitLinkDestroy_13_3 (handle);
}
#else
extern nvJitLinkResult nvJitLinkDestroy (nvJitLinkHandle *handle);
#endif
 
extern nvJitLinkResult __nvJitLinkAddData_13_3(
  nvJitLinkHandle handle,
...
static inline nvJitLinkResult nvJitLinkAddData(
  ...
  const char *name) // name can be null
{
  return __nvJitLinkAddData_13_3 (handle, inputType, data, size, name);
}
#else
extern nvJitLinkResult nvJitLinkAddData(
  nvJitLinkHandle handle,
  nvJitLinkInputType inputType,
  const void *data,
  size_t size,
...
extern nvJitLinkResult __nvJitLinkAddFile_13_3(
  nvJitLinkHandle handle,
  nvJitLinkInputType inputType,
...
static inline nvJitLinkResult nvJitLinkAddFile(
  ...
  const char *fileName) // includes path to file
{
  return __nvJitLinkAddFile_13_3 (handle, inputType, fileName);
}
#else
extern nvJitLinkResult nvJitLinkAddFile(
  nvJitLinkHandle handle,
  nvJitLinkInputType inputType,
  const char *fileName); // includes path to file
#endif
 
extern nvJitLinkResult __nvJitLinkComplete_13_3 (nvJitLinkHandle handle);
/**
 * \ingroup linking
...
{
  return __nvJitLinkComplete_13_3 (handle);
}
#else
extern nvJitLinkResult nvJitLinkComplete (nvJitLinkHandle handle);
#endif
 
extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_13_3(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedCubinSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetLinkedCubinSize_13_3 (handle, size);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedCubinSize(
  nvJitLinkHandle handle,
  size_t *size);
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedCubin_13_3(
  nvJitLinkHandle handle,
  void *cubin);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedCubin(
  ...
  void *cubin)
{
  return __nvJitLinkGetLinkedCubin_13_3 (handle, cubin);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedCubin(
  nvJitLinkHandle handle,
  void *cubin);
#endif
 
extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_13_3(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedPtxSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetLinkedPtxSize_13_3 (handle, size);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedPtxSize(
  nvJitLinkHandle handle,
  size_t *size);
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedPtx_13_3(
  nvJitLinkHandle handle,
  char *ptx);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedPtx(
  ...
  char *ptx)
{
  return __nvJitLinkGetLinkedPtx_13_3 (handle, ptx);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedPtx(
  nvJitLinkHandle handle,
  char *ptx);
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedLTOIRSize_13_3(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
 * \brief   nvJitLinkGetLinkedLTOIRSize gets the size of the linked LTOIR.
 *
 * \param    [in] handle      nvJitLink handle.
 * \param    [out] size       Size of the linked LTOIR.
 * \return
 *   - \link #nvJitLinkResult NVJITLINK_SUCCESS \endlink
 *   - \link #nvJitLinkResult NVJITLINK_ERROR_INVALID_INPUT\endlink
 *   - \link #nvJitLinkResult NVJITLINK_ERROR_INTERNAL\endlink
 *
 * Linked LTOIR is only available when using the \c -lto option.
 * The returned data is in LTOIR Container format (not raw bitcode).
 * \see nvJitLinkGetLinkedLTOIR
 */
#ifndef NVJITLINK_NO_INLINE
static inline nvJitLinkResult nvJitLinkGetLinkedLTOIRSize(
  nvJitLinkHandle handle,
  size_t *size)
{
  return __nvJitLinkGetLinkedLTOIRSize_13_3 (handle, size);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedLTOIRSize(
  nvJitLinkHandle handle,
  size_t *size);
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedLTOIR_13_3(
  nvJitLinkHandle handle,
  void *ltoir);
/**
 * \ingroup linking
 * \brief   nvJitLinkGetLinkedLTOIR gets the linked LTOIR.
 *
 * \param    [in] handle      nvJitLink handle.
 * \param    [out] ltoir      The linked LTOIR in Container format.
 * \return
 *   - \link #nvJitLinkResult NVJITLINK_SUCCESS \endlink
 *   - \link #nvJitLinkResult NVJITLINK_ERROR_INVALID_INPUT\endlink
 *   - \link #nvJitLinkResult NVJITLINK_ERROR_INTERNAL\endlink
 *
 * Linked LTOIR is only available when using the \c -lto option.
 * User is responsible for allocating enough space to hold the \p ltoir.
 * The returned data is in LTOIR Container format (not raw bitcode).
 * \see nvJitLinkGetLinkedLTOIRSize
 */
#ifndef NVJITLINK_NO_INLINE
static inline nvJitLinkResult nvJitLinkGetLinkedLTOIR(
  nvJitLinkHandle handle,
  void *ltoir)
{
  return __nvJitLinkGetLinkedLTOIR_13_3 (handle, ltoir);
}
#else
extern nvJitLinkResult nvJitLinkGetLinkedLTOIR(
  nvJitLinkHandle handle,
  void *ltoir);
#endif
 
extern nvJitLinkResult __nvJitLinkGetErrorLogSize_13_3(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetErrorLogSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetErrorLogSize_13_3 (handle, size);
}
#else
extern nvJitLinkResult nvJitLinkGetErrorLogSize(
  nvJitLinkHandle handle,
  size_t *size);
#endif

extern nvJitLinkResult __nvJitLinkGetErrorLog_13_3(
  nvJitLinkHandle handle,
  char *log);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetErrorLog(
  ...
  char *log)
{
  return __nvJitLinkGetErrorLog_13_3 (handle, log);
}
#else
extern nvJitLinkResult nvJitLinkGetErrorLog(
  nvJitLinkHandle handle,
  char *log);
#endif

extern nvJitLinkResult __nvJitLinkGetInfoLogSize_13_3(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetInfoLogSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetInfoLogSize_13_3 (handle, size);
}
#else
extern nvJitLinkResult nvJitLinkGetInfoLogSize(
  nvJitLinkHandle handle,
  size_t *size);
#endif

extern nvJitLinkResult __nvJitLinkGetInfoLog_13_3(
  nvJitLinkHandle handle,
  char *log);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetInfoLog(
  ...
  char *log)
{
  return __nvJitLinkGetInfoLog_13_3 (handle, log);
}
#else
extern nvJitLinkResult nvJitLinkGetInfoLog(
  nvJitLinkHandle handle,
  char *log);
#endif
